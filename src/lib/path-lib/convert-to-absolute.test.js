...
describe('convert-to-absolute', () => {
  ...
  it('should works with absolute target path', () => {
    const actual = convertToAbsolute(
      'feature-sliced-frontend/src/entities/foo-bar-baz/ui/index.vue',
      'feature-sliced-frontend/src/entities/foo-bar-baz/ui/index.vue',
    );
    const expected = 'feature-sliced-frontend/src/entities/foo-bar-baz/ui/index.vue';
  ...
  it('should works 5', () => {
    const actual = convertToAbsolute(
      'src/entities/foo/bar.ts',
      './baz.ts',
    );
    const expected = 'src/entities/foo/baz.ts';
  ...
  it('should works 6', () => {
    const actual = convertToAbsolute(
      'src/pages/foo-bar/lib/index.ts',
      './generatePayloadMapper',
    );
    const expected = 'src/pages/foo-bar/lib/generatePayloadMapper';
